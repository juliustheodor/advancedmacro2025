...
\begin{frame}{Problem Set 7, Question 1: Empirical Business Cycles} 
\metroset{block=fill}
\begin{alertblock}{\textcolor{blue}{Question 1}}
   Download data for GDP, consumption, and investment for Germany. Choose quarterly data for at least 10 years (for example, from 1996 to 2023). A reliable source for aggregate time series is provided by \href{https://fred.stlouisfed.org}{FRED} or \href{http://ec.europa.eu/eurostat/data/database}{Eurostat}. Make sure to choose \emph{real} (at constant prices) and \emph{seasonally-adjusted} time series. For the following exercises, you might use the software package of your choice (e.g., Matlab, Stata, R).
\end{alertblock} 
\end{frame}
...
\begin{figure}[hbt]
  \includegraphics[width=0.9\textwidth]{figures/Figure1GermanGDP.png}
...
\begin{column}{0.5\textwidth}
	\begin{figure}[hbt]
  \includegraphics[width=1.05\textwidth]{figures/Figure2GermanGDPLinearTrend.png} \vspace{-0.4cm} 
...
\begin{frame}{Hodrick–Prescott filter} 
\begin{figure}[hbt]
  \includegraphics[width=\textwidth]{figures/Figure4.png} \vspace{-1cm}
...
\vspace{-0.3cm}
\begin{figure}[hbt]
  \includegraphics[width=\textwidth]{figures/Figure5.png} \vspace{-1cm}
...
Briefly discuss the role of $\lambda$ for the estimated trend. What are potential disadvantages of the Hodrick-Prescott filter? 	
\end{alertblock}
