...
\begin{frame}{Example: AR(1) processes} 
\begin{figure}[hbt]
  \includegraphics[width=0.8\textwidth]{figures/Figure0.png}
  \caption{Three AR(1) processes obtained from the same shock series. }
\end{figure}
\end{frame}
